...
export default function NewCategoryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.titleEn || !formData.titlePt) {
    ...
    setSaving(true);
    try {
      await vocabularyService.createCategory(formData);
    ...
    <DashboardLayout>
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Crie uma nova categoria para o desafio de vocabulário</p>
        </div>
